    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.CharField(choices=[('COST_AND_COST_REDUCTION', 'Cost and Cost Reduction'), ('PRODUCTIVITY_INCREASE', 'Productivity Increase'), ('QUALITY_AND_DATA_INCREASE', 'Quality and Data Increase'), ('SAFETY_INCREASE', 'Safety Increase'), ('LEARNING_AND_GROWTH_INCREASE', 'Learning and Growth Increase'), ('USER_SATISFACTION', 'User Satisfaction')], max_length=100, null=True)),
