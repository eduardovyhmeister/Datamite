...
class KPIModelTest(TestCase):
    ...
    def setUp(self):
        ...
        # Add a BCS families and a BSC subfamilies into the DB.
        for i in range(4):
            ...
            for i in range(3):
                new_subfamily = BSCSubfamily(name = f"Test subfamily {i}",
                                             bsc_family = new_BSCFamily,
                                             short_definition = f"This is the test subfamily #{i}.",
                                             explanation = f"his a longer explanation of the fact that it is the test subfamily #{i}.")
