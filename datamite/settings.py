"""
Django settings for datamite project.
...
WSGI_APPLICATION = 'datamite.wsgi.application'
...
# This ensures WhiteNoise compresses and serves static files
...
CSRF_TRUSTED_ORIGINS = ['https://datamite.insight-centre.org']
